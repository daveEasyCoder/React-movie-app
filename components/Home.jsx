      ...
      <div className="relative">
        <div className=" max-w-4xl flex items-center justify-between m-auto mb-7 mt-9 px-2.5">
          <input onChange={handleSearchChange}
            className="input-box bg-transparent outline-0 border border-gray-400 flex-1/2 px-2 py-2.5 placeholder-gray text-sm text-gray-100 placeholder:text-sm rounded-l-sm mr-0.5"
            type="text"
